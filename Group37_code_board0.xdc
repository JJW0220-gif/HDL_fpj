...
#    set_property IOSTANDARD LVCMOS33 [get_ports {sw[14]}]
 set_property PACKAGE_PIN R2 [get_ports {in}]
...
# set_property PACKAGE_PIN U19 [get_ports {nn}]
# set_property IOSTANDARD LVCMOS33 [get_ports {nn}]
#set_property PACKAGE_PIN V19 [get_ports {out}]
...
# set_property PACKAGE_PIN P3 [get_ports {light[0]}]
# set_property IOSTANDARD LVCMOS33 [get_ports {light[0]}]
# set_property PACKAGE_PIN N3 [get_ports {light[1]}]
# set_property IOSTANDARD LVCMOS33 [get_ports {light[1]}]
# set_property PACKAGE_PIN P1 [get_ports {light[2]}]
# set_property IOSTANDARD LVCMOS33 [get_ports {light[2]}]
# set_property PACKAGE_PIN L1 [get_ports {light[3]}]
...
# set_property PACKAGE_PIN T18 [get_ports finish]
#    set_property IOSTANDARD LVCMOS33 [get_ports finish]
# set_property PACKAGE_PIN W19 [get_ports btnL]
#    set_property IOSTANDARD LVCMOS33 [get_ports btnL]
set_property PACKAGE_PIN T17 [get_ports sure]       
...
## Pmod Header JA
# Sch name = JA1
 set_property PACKAGE_PIN J1 [get_ports {light[0]}]
    set_property IOSTANDARD LVCMOS33 [get_ports {light[0]}]
### Sch name = JA2
 set_property PACKAGE_PIN L2 [get_ports {light[1]}]
    set_property IOSTANDARD LVCMOS33 [get_ports {light[1]}]
### Sch name = JA3
 set_property PACKAGE_PIN J2 [get_ports {light[2]}]
    set_property IOSTANDARD LVCMOS33 [get_ports {light[2]}]
#### Sch name = JA4
 set_property PACKAGE_PIN G2 [get_ports {nn}]
    set_property IOSTANDARD LVCMOS33 [get_ports {nn}]
### Sch name = JA7
 set_property PACKAGE_PIN H1 [get_ports {out}]
    set_property IOSTANDARD LVCMOS33 [get_ports {out}]
## Sch name = JA8
 set_property PACKAGE_PIN K2 [get_ports {in}]
    set_property IOSTANDARD LVCMOS33 [get_ports {in}]
### Sch name = JA9
 set_property PACKAGE_PIN H2 [get_ports {bbgin}]
    set_property IOSTANDARD LVCMOS33 [get_ports {bbgin}]
## Sch name = JA10
...
## Sch name = JC1
## Sch name = JC1                                             
 set_property PACKAGE_PIN K17 [get_ports {filter_select[0]}]              
   set_property IOSTANDARD LVCMOS33 [get_ports {filter_select[0]}]       
## Sch name = JC2                                             
 set_property PACKAGE_PIN M18 [get_ports {filter_select[1]}]              
   set_property IOSTANDARD LVCMOS33 [get_ports {filter_select[1]}]       
# Sch name = JC3                                              
set_property PACKAGE_PIN N17 [get_ports {frequncy_rate[0]}]          
    set_property IOSTANDARD LVCMOS33 [get_ports {frequncy_rate[0]}]   
# Sch name = JC4                                              
set_property PACKAGE_PIN P18 [get_ports {frequncy_rate[1]}]          
    set_property IOSTANDARD LVCMOS33 [get_ports {frequncy_rate[1]}]  
## Sch name = JC7                                             
 set_property PACKAGE_PIN L17 [get_ports {PMS1}]               
    set_property IOSTANDARD LVCMOS33 [get_ports {PMS1}]        
# Sch name = JC8                                             
 set_property PACKAGE_PIN M19 [get_ports {PMS2}]            
    set_property IOSTANDARD LVCMOS33 [get_ports {PMS2}]     
## Sch name = JC9                                             
set_property PACKAGE_PIN P17 [get_ports {frequncy}]            
   set_property IOSTANDARD LVCMOS33 [get_ports {frequncy}]     
## Sch name = JC10                                            
...
## Pmod Header JXADC
### Sch name = XA1_P
# set_property PACKAGE_PIN J3 [get_ports {frequncy_rate[0]}]
#    set_property IOSTANDARD LVCMOS33 [get_ports {frequncy_rate[0]}]
## Sch name = XA2_P
# set_property PACKAGE_PIN L3 [get_ports {frequncy_rate[1]}]
#    set_property IOSTANDARD LVCMOS33 [get_ports {frequncy_rate[1]}]
## Sch name = XA3_P
# set_property PACKAGE_PIN M2 [get_ports {filter_select[0]}]
#    set_property IOSTANDARD LVCMOS33 [get_ports {filter_select[0]}]
## Sch name = XA4_P
#x}]
# set_property PACKAGE_PIN N2 [get_ports {filter_select[1]}]
#   set_property IOSTANDARD LVCMOS33 [get_ports {filter_select[1]}]
##   set_property PULLUP true [get_ports ble_rx]

### Sch name = XA1_N
# set_property PACKAGE_PIN K3 [get_ports {frequncy}]
#    set_property IOSTANDARD LVCMOS33 [get_ports {frequncy}]
### Sch name = XA2_N
# set_property PACKAGE_PIN M3 [get_ports {led}]
#    set_property IOSTANDARD LVCMOS33 [get_ports {led}]
## Sch name = XA3_N
